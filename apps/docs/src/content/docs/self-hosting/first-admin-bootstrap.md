...
## 首次管理员 bootstrap [#self-hosting-first-admin-bootstrap]
...
## 登录 console [#self-hosting-first-admin-login]
...
## Bootstrap status 和 setup API [#self-hosting-first-admin-public-api]
...
## OAuth 是可选项 [#self-hosting-first-admin-oauth]
...
## 下一步：管理 organization 成员 [#self-hosting-first-admin-next-team]
...
## 恢复和排查 [#self-hosting-first-admin-recovery]
