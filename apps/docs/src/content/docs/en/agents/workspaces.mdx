...
If **Preparing disk** fails because Cloud is temporarily unreachable (HTTP 502 or
503, including a Cloudflare bad-gateway page), the Cloud Agents screen restores
the terminal first, then prints a next step such as
