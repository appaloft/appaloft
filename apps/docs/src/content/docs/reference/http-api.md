...
## 共享操作 schema [#api-shared-operation-schema]

HTTP/oRPC 输入必须复用业务操作 schema。文档应解释字段含义，而不是为 HTTP 单独发明另一套业务语义。

## OpenAPI 和 Scalar reference [#api-openapi-reference]
