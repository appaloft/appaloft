	...
	export const buttonVariants = tv({
		...
		variants: {
			variant: {
				...
				selected:
					"border-primary/35 bg-accent text-accent-foreground shadow-xs ring-1 ring-primary/15 hover:bg-accent/80 dark:border-primary/45 dark:bg-accent dark:hover:bg-accent/80 aria-expanded:bg-accent aria-expanded:text-accent-foreground",
				outline:
