...
describe("resource auto-deploy console settings", () => {
  test("[RES-DETAIL-IA-001] Resource detail groups owner surfaces into primary tabs and secondary sections", async () => {
    ...
    expect(source).toContain('<div class="console-detail-page">');
    expect(source).toContain('<div class="console-detail-body">');
    expect(source).toContain("console-detail-tab-panel");
    expect(source).toContain("console-detail-tab-panel-subnav");
    ...
    expect(source).toContain("console-subnav-layout console-detail-subnav-layout");
    expect(source).not.toContain("console-detail-subnav-layout lg:min-h-[42rem]");
    expect(source).not.toContain("lg:grid-cols-[10.5rem_minmax(0,1fr)]");
    expect(source).toContain('<aside class="console-subnav">');
