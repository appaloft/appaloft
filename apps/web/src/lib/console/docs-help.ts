...
export const webDocsHrefs = {
  ...
  resourceScaleRolloutProfile: resolvePublicDocsHelpHref("resource.scale-rollout-profile"),
...
export const webDocsTooltipKeys = {
  ...
  serverRuntimeTargetProfile: i18nKeys.console.docsHelp.serverRuntimeTargetProfile,
  ...
  resourceScaleRolloutProfile: i18nKeys.console.docsHelp.resourceScaleRolloutProfile,
