<script lang="ts">
  ...
  function requestCleanup(): void {
    if (!previewEnvironment || !canRequestCleanup) {
      return;
    }
...
>
  ...
  {:else}
    <div class="space-y-8" data-preview-environment-detail-display-surface>
      ...
      <section class="grid gap-4 lg:grid-cols-3">
        ...
        <div class="console-panel space-y-3 p-5">
          ...
          <div class="rounded-md border bg-muted/15 px-3 py-2" data-preview-environment-cleanup-handoff>
              ...
              <div class="flex min-w-0 items-start gap-3">
                ...
                <div class="min-w-0">
                  ...
                  <p class="mt-1 text-xs text-muted-foreground">
                    {canRequestCleanup
                      ? $t(i18nKeys.console.previewEnvironments.lifecycleReady)
                      : $t(i18nKeys.console.previewEnvironments.lifecycleBlocked)}
                  </p>
                </div>
              </div>
              <Button
    ...
    <Dialog.Root bind:open={cleanupDialogOpen}>
      <Dialog.Content closeLabel={$t(i18nKeys.common.actions.close)}>
        ...
        <div class="space-y-5 px-5 pb-5" data-preview-environment-cleanup-dialog>
          <div class="rounded-md border bg-muted/20 px-3 py-2 text-sm">
            <p class="break-all font-mono font-medium">
              {previewEnvironment.previewEnvironmentId}
            </p>
            <p class="mt-1 text-xs text-muted-foreground">
              {previewEnvironment.source.repositoryFullName}
            ...
            <p class="mt-1 break-all text-xs text-muted-foreground">
              {$t(i18nKeys.common.domain.resource)} · {previewEnvironment.resourceId}
            </p>
          </div>
