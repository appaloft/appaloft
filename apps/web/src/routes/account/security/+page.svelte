...
>
  ...
  {#if feedback}
    <div class="mt-6 rounded-[calc(var(--radius-lg)-2px)] border border-primary/30 bg-primary/5 p-4 text-sm">
      {feedback}
    </div>
  {/if}

  {#if operationError}
    <div class="mt-6 rounded-[calc(var(--radius-lg)-2px)] border border-destructive/30 bg-destructive/5 p-4 text-sm">
