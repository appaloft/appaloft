...
| `version` | `latest` | Appaloft CLI release tag such as `v0.9.1`. |
...
Appaloft Cloud or self-hosted control-plane workflows that reuse the same operation catalog instead
of adding preview fields to `deployments.create`.
