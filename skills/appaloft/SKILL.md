...
`npx skills add appaloft/appaloft/skills/appaloft` installs this skill into a skill host through
the standard skill manager. It only copies skill files. It does not deploy, create resources, call
APIs, or wrap the Appaloft CLI. Use `npx @appaloft/skills install appaloft/appaloft` only as a
