...
| --- | --- | --- |
| Web | Resource detail runtime controls. | Active |
| CLI | `appaloft resource runtime start <resourceId>`. | Active |
| oRPC / HTTP | `POST /api/resources/{resourceId}/runtime/start`. | Active |
