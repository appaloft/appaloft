...
| `dependency_resource_backup_blocked` | `conflict` | phase `dependency-resource-backup-admission`; dependency resource id, dependency kind, provider key when known, blocker reason code |
| `dependency_resource_restore_blocked` | `conflict` | phase `dependency-resource-restore-admission`; backup id, dependency resource id, dependency kind, provider key when known, blocker reason code |
