...
- Runtime adapter translation and shell dependency registration exist for server-scope capacity
  ...
  retained runtime identity metadata enriching deployment-id-only artifacts. Future MCP/tool tests
  remain pending.
