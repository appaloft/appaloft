...
are active recovery operations. Runtime stop/start/restart remains unimplemented until command
specs, error specs, readback placement, adapter contracts, public docs/help, and tests are aligned.
