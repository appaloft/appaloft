...
| PUB-DOCS-011A | CLI help is available without runtime composition. | integration | `appaloft deploy --help` renders help without initializing persistence, starting services, or requiring a usable local runtime data directory. |
