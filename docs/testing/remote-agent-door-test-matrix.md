...
| WS-REMOTE-PROGRESS-207 | TUI | automated | `?` shows the Railway `ca` key table; n/c/t/setup say unavailable; s/w/d map to pause/resume/terminate | `apps/workspace-control-tui/src/lib.rs` |
