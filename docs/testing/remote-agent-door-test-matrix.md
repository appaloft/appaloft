...
| WS-REMOTE-CONNECT-215 | CLI | automated | connecting-step data includes credential, skill count, and work-on-disk | `packages/adapters/cli/test/occupancy-connecting-telemetry.test.ts` |
