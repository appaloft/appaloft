...
| SELF-AUTH-DOCS-001 | docs/help | Public docs and help coverage | Deploy token auth is user-visible | Docs/help explain setup, GitHub Secret use, 401/403, scopes, rotation, revocation, and migration from anonymous self-hosted Action endpoints | None | Docs registry/help lookup |
