...
| TS-SDK-ERROR-002 | SDK runtime | Sanitized unexpected response handling | HTML and non-JSON responses return stable structured errors without response bodies; HTTP 502, 503, and 504 variants are retriable and other statuses are non-retriable. |
