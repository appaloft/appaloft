...
- Feedback pass: moved the main canvas to Supabase-like near-white `#fdfdfd` and made deploy stepper
  states explicit so non-error steps cannot inherit red or pink fills.
