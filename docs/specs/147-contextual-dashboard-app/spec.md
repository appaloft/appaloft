...
| DASH-DATA-016 | Switching the Resource destination or opening/closing the panel never re-requests or re-enters loading in the background Project Overview; its queries depend only on Project scope, Environment, and collection inputs. |
