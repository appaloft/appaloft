...
- the first Cloud auth mechanism or Cloud default URL policy is selected;
...
- `CONTROL-PLANE-CLI-001` through `CONTROL-PLANE-CLI-011` for profile/login/context/dispatch.
