# Tasks: Remote MCP Access For Agent Workspaces

- [x] Record owner-confirmed discovery, ADR, Spec, plan, and Test Matrix.
- [x] Create public [#1015](https://github.com/appaloft/appaloft/issues/1015) and mark it
  `ready-for-agent`.
- [x] Add failing Adapter/Profile contract tests.
...
- [ ] Merge public PR and pin its final `main` SHA in Cloud.
- [ ] Complete independent boundary review and sync evidence.
