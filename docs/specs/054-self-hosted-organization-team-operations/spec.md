...
| ORG-TEAM-SPEC-004 | Update member role | An owner updates another member's role | The role update command runs | The member role changes only if the actor has permission and the organization keeps at least one owner. |
