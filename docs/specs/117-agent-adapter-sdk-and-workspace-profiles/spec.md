...
| ADAPTER-CRED-006 | Credential requirements | An Adapter needs model or forge access | A Profile/Workspace binds it | Only named references/grants cross the boundary; no secret value enters manifest or evidence. |
