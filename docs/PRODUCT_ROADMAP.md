...
- [x] On 2026-08-04, the latest public release is `v1.7.3`; root package
  and Release Please manifest on `main` are `1.7.3`; the release PR target is
  `1.7.4`.
- [x] On 2026-08-04, the roadmap gate allows `Release-As: 1.7.4` because
