...
- [x] On 2026-07-08, the latest public release is `v1.0.0`; root package
  and Release Please manifest on `main` are `1.0.0`; the release PR target is
  `1.0.1`.
- [x] On 2026-07-08, the roadmap gate allows `Release-As: 1.0.1` because
