...
- [x] On 2026-07-27, the latest public release is `v1.3.2`; root package
  and Release Please manifest on `main` are `1.3.2`; the release PR target is
  `1.4.0`.
- [x] On 2026-07-27, the roadmap gate allows `Release-As: 1.4.0` because
