...
- [x] On 2026-07-16, the latest public release is `v1.0.3`; root package
  and Release Please manifest on `main` are `1.0.3`; the release PR target is
  `1.0.4`.
- [x] On 2026-07-16, the roadmap gate allows `Release-As: 1.0.4` because
