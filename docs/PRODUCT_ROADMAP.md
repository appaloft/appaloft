...
- [x] On 2026-08-22, the latest public release is `v1.9.2`; root package
  and Release Please manifest on `main` are `1.9.2`; the release PR target is
  `1.9.3`.
- [x] On 2026-08-22, the roadmap gate allows `Release-As: 1.9.3` because
