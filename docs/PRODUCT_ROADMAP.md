...
- [x] On 2026-08-22, the latest public release is `v1.10.3`; root package
  and Release Please manifest on `main` are `1.10.3`; the release PR target is
  `1.10.4`.
- [x] On 2026-08-22, the roadmap gate allows `Release-As: 1.10.4` because
