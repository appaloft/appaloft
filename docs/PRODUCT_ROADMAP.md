...
- [x] On 2026-08-23, the latest public release is `v1.10.6`; root package
  and Release Please manifest on `main` are `1.10.6`; the release PR target is
  `1.10.7`.
- [x] On 2026-08-23, the roadmap gate allows `Release-As: 1.10.7` because
