...
- [x] On 2026-07-27, the latest public release is `v1.4.0`; root package
  and Release Please manifest on `main` are `1.4.0`; the release PR target is
  `1.5.0`.
- [x] On 2026-07-27, the roadmap gate allows `Release-As: 1.5.0` because
