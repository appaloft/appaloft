...
- [x] On 2026-05-19, the latest public release is `v0.12.4`; root package
  and Release Please manifest on `main` are `1.0.0-rc.11`; the release PR target is
  `1.0.0-rc.12`.
- [x] On 2026-05-19, the roadmap gate allows `Release-As: 1.0.0-rc.12` because
