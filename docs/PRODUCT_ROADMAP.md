...
- [x] On 2026-08-23, the latest public release is `v1.10.9`; root package
  and Release Please manifest on `main` are `1.10.9`; the release PR target is
  `1.10.10`.
- [x] On 2026-08-23, the roadmap gate allows `Release-As: 1.10.10` because
...
- [ ] Post-1.0 Track 8: Execution Sandbox Platform. This is now accepted for Code Round by
  ...
  The follow-on hibernation/recovery slice is governed by
  [ADR-097](./decisions/ADR-097-workspace-hibernation-and-recovery.md) and
  [Spec 114](./specs/114-workspace-hibernation-and-recovery/spec.md).
