...
- [x] On 2026-07-21, the latest public release is `v1.0.4`; root package
  and Release Please manifest on `main` are `1.0.4`; the release PR target is
  `1.1.0`.
- [x] On 2026-07-21, the roadmap gate allows `Release-As: 1.1.0` because
