...
- [x] On 2026-08-18, the latest public release is `v1.8.14`; root package
  and Release Please manifest on `main` are `1.8.14`; the release PR target is
  `1.8.15`.
- [x] On 2026-08-18, the roadmap gate allows `Release-As: 1.8.15` because
