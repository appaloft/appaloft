...
- [x] On 2026-05-14, the latest public release is `v0.12.1`; root package
  and Release Please manifest on `main` are `0.12.1`; the release PR target is
  `0.12.2`.
- [x] On 2026-05-14, the roadmap gate allows `Release-As: 0.12.2` because
