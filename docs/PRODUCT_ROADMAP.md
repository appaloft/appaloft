...
- [x] On 2026-07-28, the latest public release is `v1.5.0`; root package
  and Release Please manifest on `main` are `1.5.0`; the release PR target is
  `1.6.0`.
- [x] On 2026-07-28, the roadmap gate allows `Release-As: 1.6.0` because
