...
- [x] On 2026-05-09, the latest public release is `v0.9.6`; root package
  and Release Please manifest on `main` are `0.9.6`; the release PR target is
  `0.9.7`.
- [x] On 2026-05-09, the roadmap gate allows `Release-As: 0.9.7` because
