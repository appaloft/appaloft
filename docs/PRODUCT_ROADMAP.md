...
- [x] On 2026-08-19, the latest public release is `v1.9.0`; root package
  and Release Please manifest on `main` are `1.9.0`; the release PR target is
  `1.9.1`.
- [x] On 2026-08-19, the roadmap gate allows `Release-As: 1.9.1` because
