...
| `sandbox-snapshots.list` | Bounded retained Snapshot summaries including capture reason and recovery portability. |
| `sandbox-snapshots.show` | One Snapshot capability, source, lifecycle, retention, reason and compatible recovery-family descriptor. |
