...
| Update organization member role | Admin/operator-protected command | `organizations.update-member-role` | `UpdateOrganizationMemberRoleCommand` | `UpdateOrganizationMemberRoleCommandInput` | `appaloft organization member role <memberId>` | `POST /api/organizations/{organizationId}/members/{memberId}/role` |
