...
| Configure domain binding certificate policy | Command (planned; ticket required) | `domain-bindings.configure-certificate-policy` | `ConfigureDomainBindingCertificatePolicyCommand` | `ConfigureDomainBindingCertificatePolicyCommandInput` | `appaloft domain-binding configure-certificate-policy <domainBindingId> --policy auto\|manual` | `POST /api/domain-bindings/{domainBindingId}/certificate-policy` |
