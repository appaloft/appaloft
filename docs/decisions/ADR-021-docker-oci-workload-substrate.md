...
- richer runtime-profile fields beyond Dockerfile, Compose, Docker build target, and static publish
  directory still need separate typed resource runtime-profile value objects when accepted;
