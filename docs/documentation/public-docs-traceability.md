...
| `environment.lifecycle` | `/docs/environments/model/#environment-lifecycle` | `docs/workflows/environment-lifecycle.md`; `docs/commands/environments.clone.md`; `docs/commands/environments.lock.md`; `docs/commands/environments.unlock.md`; `docs/commands/environments.archive.md`; `docs/events/environment-locked.md`; `docs/events/environment-unlocked.md`; `docs/events/environment-archived.md`; `docs/errors/environments.lifecycle.md`; `docs/testing/environment-lifecycle-test-matrix.md` | Project detail environment lifecycle action |
