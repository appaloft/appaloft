...
| `resource.source-profile` | `/docs/resources/profiles/source-runtime/#resource-source-profile` | `docs/decisions/ADR-012-resource-runtime-profile-and-deployment-snapshot-boundary.md`; `docs/commands/resources.configure-source.md`; `docs/workflows/resource-profile-lifecycle.md`; `docs/testing/resource-profile-lifecycle-test-matrix.md`; `docs/specs/008-resource-detail-profile-editing/spec.md` | `apps/web/src/routes/resources/[resourceId]/+page.svelte` resource source profile form |
| `resource.runtime-profile` | `/docs/resources/profiles/source-runtime/#resource-runtime-profile` | `docs/decisions/ADR-012-resource-runtime-profile-and-deployment-snapshot-boundary.md`; `docs/commands/resources.configure-runtime.md`; `docs/workflows/resource-profile-lifecycle.md`; `docs/testing/resource-profile-lifecycle-test-matrix.md`; `docs/specs/008-resource-detail-profile-editing/spec.md` | `apps/web/src/routes/resources/[resourceId]/+page.svelte` resource runtime profile form |
| `resource.network-profile` | `/docs/resources/profiles/health-network/#resource-network-profile` | `docs/decisions/ADR-015-resource-network-profile.md`; `docs/commands/resources.configure-network.md`; `docs/workflows/resource-profile-lifecycle.md`; `docs/testing/resource-profile-lifecycle-test-matrix.md`; `docs/specs/008-resource-detail-profile-editing/spec.md` | `apps/web/src/routes/resources/[resourceId]/+page.svelte` resource network profile form |
| `resource.access-profile` | `/docs/access/generated-routes/#resource-access-profile` | `docs/decisions/ADR-017-default-access-domain-and-proxy-routing.md`; `docs/commands/resources.configure-access.md`; `docs/events/resource-access-configured.md`; `docs/workflows/resource-profile-lifecycle.md`; `docs/testing/resource-profile-lifecycle-test-matrix.md`; `docs/specs/007-resource-access-profile-configuration/spec.md` | `apps/web/src/routes/resources/[resourceId]/+page.svelte` resource access form |
