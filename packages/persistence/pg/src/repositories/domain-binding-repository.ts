  ...
  visitUpsertDomainBinding(spec: UpsertDomainBindingSpec) {
    return {
      values: {
        ...
        server_id: spec.state.serverId?.value ?? null,
        ...
        path_handling: spec.state.pathHandling?.value ?? "preserve",
        proxy_kind: spec.state.proxyKind.value,
        tls_mode: spec.state.tlsMode.value,
        target_service_name: spec.state.targetServiceName?.value ?? null,
        ...
        active_certificate_id: spec.state.activeCertificateProof?.certificateId.value ?? null,
        active_certificate_fingerprint:
          spec.state.activeCertificateProof?.fingerprint.value ?? null,
        ...
        await executor
          ...
          .onConflict((conflict) =>
            conflict.column("id").doUpdateSet({
              ...
              path_handling: mutation.values.path_handling,
              proxy_kind: mutation.values.proxy_kind,
              tls_mode: mutation.values.tls_mode,
              target_service_name: mutation.values.target_service_name,
              redirect_to: mutation.values.redirect_to,
              redirect_status: mutation.values.redirect_status,
              certificate_policy: mutation.values.certificate_policy,
              active_certificate_id: mutation.values.active_certificate_id,
              active_certificate_fingerprint: mutation.values.active_certificate_fingerprint,
