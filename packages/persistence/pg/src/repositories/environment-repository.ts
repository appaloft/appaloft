  ...
  visitUpsertEnvironment(spec: UpsertEnvironmentSpec) {
    return {
      environment: {
        ...
        locked_at: spec.state.lockedAt?.value ?? null,
        lock_reason: spec.state.lockReason?.value ?? null,
          ...
          await transaction
            ...
            .onConflict((conflict) =>
              conflict.column("id").doUpdateSet({
                ...
                locked_at: mutation.environment.locked_at ?? null,
                lock_reason: mutation.environment.lock_reason ?? null,
