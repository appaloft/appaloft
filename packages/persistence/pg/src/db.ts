...
import { deploymentTimelineJournalMigration } from "./migrations/091_deployment_timeline_journal";
...
class StaticMigrationProvider implements MigrationProvider {
  async getMigrations() {
    return {
      ...
      "091_deployment_timeline_journal": deploymentTimelineJournalMigration,
    };
  }
}
