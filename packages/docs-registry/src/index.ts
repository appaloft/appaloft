...
export const publicDocsHelpTopics = {
  ...
  "agent.workspace": {
    ...
    description:
      "How to initialize, open, resume, attach to, inspect target evidence for, preview, and clean up a Profile-aware Agent Workspace.",
    page: {
  ...
  "server.deployment-target": {
    ...
    description:
      "What a server means as a deployment target and runtime preparation boundary in Appaloft.",
    page: {
  ...
  "storage.volume-lifecycle": {
    ...
    specReferences: [
      ...
      "docs/specs/096-storage-volume-resource-visibility/spec.md",
      "docs/specs/098-storage-volume-backup-restore/spec.md",
      "docs/decisions/ADR-064-storage-volume-runtime-realization-and-cleanup.md",
      "docs/decisions/ADR-083-storage-volume-dependency-resource-and-backup-boundary.md",
      ...
      "docs/commands/storage-volumes.create-backup.md",
      "docs/commands/storage-volumes.restore-backup.md",
      "docs/commands/storage-volumes.prune-backups.md",
      ...
      "docs/queries/storage-volumes.backup-plan.md",
      "docs/queries/storage-volumes.list-backups.md",
      "docs/queries/storage-volumes.show-backup.md",
      "docs/queries/storage-volumes.restore-plan.md",
    ],
    webSurfaces: [
      "Web Resource detail can list/create/rename/delete provider-neutral storage volume records, attach/detach Resource storage attachments, run dry-run-first scoped runtime cleanup, and manage storage volume backup plans/artifacts/restore-to-new-volume/prune through the storageVolumes.backups oRPC surface; Bun.WebView route coverage exercises list/create/attach/detach and dry-run-first cleanup, CLI/API/Web cleanup preserves backup/restore safety evidence, and Docker Swarm Compose stack realization is deployment-driven through generated Appaloft overrides.",
    ],
  },
  "storage.volume-backup-restore": {
    id: "storage.volume-backup-restore",
    title: "Storage volume backup and restore",
    description:
    ...
    surfaces: ["cli", "http-api", "web", "mcp"],
    relatedOperation: "storage-volumes.backup-plan",
    aliases: [
      "storage backup",
      "volume backup",
      "sqlite volume backup",
      "application data backup",
      "backup source adapter",
    ...
    webSurfaces: [
      "Resource detail Storage settings plan backups, display fail-closed blockers, list safe storage backup artifacts, restore ready artifacts to a new StorageVolume, and prune selected backups without routing mounted SQLite/application data through DependencyResource backup actions.",
    ],
  },
  "dependency.resource-lifecycle": {
    ...
    specReferences: [
      ...
      "docs/specs/109-imported-dependency-connection-rotation/spec.md",
      ...
      "docs/commands/dependency-resources.rotate-connection.md",
  ...
  "blueprint.catalog-installation": {
    id: "blueprint.catalog-installation",
    title: "Blueprint catalog and installation",
    description:
    ...
    specReferences: [
      "docs/decisions/ADR-065-blueprint-format-and-local-registry-boundary.md",
      "docs/decisions/ADR-078-blueprint-component-relation-boundary.md",
      "docs/specs/087-blueprint-component-relations/spec.md",
      "docs/specs/097-application-bundle-storage-binding-boundary/spec.md",
      "docs/testing/blueprint-component-relation-test-matrix.md",
      "docs/testing/storage-volume-test-matrix.md",
    ],
    webSurfaces: [
      "Blueprint list/detail/install-plan/install acceptance and application-bundle readback surfaces preserve neutral dependency and storage binding boundaries.",
    ],
  },
...
export const publicDocsOperationCoverage = [
  ...
  ...[
    ...
    operationKey,
    status: "documented" as const,
    topicId: "agent.adapter-installations" as const,
  })),
  ...[
  ...
  ...[
    ...
    "sandboxes.list",
    "sandboxes.show",
    "sandboxes.events.stream",
    "sandbox-credentials.grant",
    "sandbox-credentials.list",
    "sandbox-credentials.revoke",
    ...
    "sandbox-processes.terminate",
    "sandbox-processes.show",
    "sandboxes.network-policy.configure",
  ...
  },
  {
    ...
    status: "documented",
    topicId: "blueprint.catalog-installation",
  },
  {
