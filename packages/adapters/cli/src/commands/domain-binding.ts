...
import { certificatePolicies, routePathHandlingModes, tlsModes } from "@appaloft/core";
...
const pathHandlingOption = Options.choice("path-handling", routePathHandlingModes).pipe(
