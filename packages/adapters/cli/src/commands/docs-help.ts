...
export const cliCommandDescriptions = {
  ...
  agentWorkspaceOpen: withDocs(
    "Create or resume a Profile-aware Workspace from a path or git remote. Places on --server or the enrolled BYOS Server",
    "agent.workspace",
  ),
  agentScratch: withDocs(
    "Occupy my Sandbox from a path or git remote, or this-Mac scratch with --local",
    "agent.scratch",
  ),
  ...
  projectUse: withDocs(
    "Link this folder to an existing project for later deploy and code commands",
    "project.lifecycle",
  ),
