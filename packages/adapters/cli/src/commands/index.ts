...
import { agentAdapterCommand } from "./agent-adapter.js";
import { agentWorkspaceCommand, workspaceCodeCommand } from "./agent-workspace.js";
import { agentWorkspaceProfileCommand } from "./agent-workspace-profile.js";
...
export const mainCommand = EffectCommand.make("appaloft").pipe(
  ...
  EffectCommand.withSubcommands([
    ...
    agentAdapterCommand,
    agentWorkspaceProfileCommand,
    workspaceCodeCommand,
