...
describe("occupancy resource logs", () => {
  test("[WS-REMOTE-LOGS-143][WS-REMOTE-HEALTH-145] copies occupancy Resource app id", () => {
    expect(
      occupancyAppResourceId(
        [
  ...
  test("[WS-REMOTE-LOGS-144][WS-REMOTE-HEALTH-146] missing occupancy Resource app stays omitted", () => {
    expect(
      occupancyAppResourceId(
        [{ id: "res_other", projectId: "prj_web", slug: "worker" }],
        "prj_web",
