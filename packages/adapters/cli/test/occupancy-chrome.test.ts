...
describe("occupancy resource logs", () => {
  test("[WS-REMOTE-LOGS-143][WS-REMOTE-HEALTH-145][WS-REMOTE-DIAG-147][WS-REMOTE-RUNTIME-153][WS-REMOTE-TERM-155] copies occupancy Resource app id", () => {
    expect(
      occupancyAppResourceId(
        [
  ...
  test("[WS-REMOTE-LOGS-144][WS-REMOTE-HEALTH-146][WS-REMOTE-DIAG-148][WS-REMOTE-RUNTIME-154][WS-REMOTE-TERM-156] missing occupancy Resource app stays omitted", () => {
    expect(
      occupancyAppResourceId(
        [{ id: "res_other", projectId: "prj_web", slug: "worker" }],
        "prj_web",
