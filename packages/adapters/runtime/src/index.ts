...
import { resolveLocalWorkspaceWorkdir } from "./local-source-workdir";
...
function autoDeploymentMethodFor(
  ...
  return ensureSourceDescriptor(source).accept<RequestedDeploymentConfig["method"]>({
    ...
    remoteGit: (visited) => workspaceMethodFromInspection(visited, requestedDeployment),
    gitPublic: (visited) => workspaceMethodFromInspection(visited, requestedDeployment),
    gitGithubApp: (visited) => workspaceMethodFromInspection(visited, requestedDeployment),
    gitDeployKey: (visited) => workspaceMethodFromInspection(visited, requestedDeployment),
