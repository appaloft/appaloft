  ...
  console: {
    ...
    instance: {
      ...
      workerManagementBody:
        "Review whether this process runs durable work, standalone worker heartbeats, and recent operator work picked up by workers.",
      ...
      workerObservedRuntimeNoHeartbeat:
        "No worker heartbeat is currently observed for this worker group.",
      ...
      workerObservedRuntimeWorkersBody:
        "These are the worker instances currently observed by the durable worker heartbeat read model.",
      ...
      workerRuntimeTopology: "Current Web/API process",
      workerRuntimeTopologyBody:
        "Only shows whether this Web/API process executes durable work. Standalone workers are based on heartbeats.",
      workerRuntimeWebDisabledHint: "This Web/API process does not execute durable work.",
      ...
      workerRuntimeWorkers: "process workers",
