  ...
  console: {
    ...
    instance: {
      ...
      workerManagementBody:
        "Review durable worker runtime topology, execution mode, heartbeat, and the recent operator work picked up by workers.",
      ...
      workerRuntimeTopologyBody:
        "Shows whether this Web/API process executes durable work. Actual handoff is shown by recent work and event logs.",
      ...
      workerRuntimeWorkers: "process slots",
