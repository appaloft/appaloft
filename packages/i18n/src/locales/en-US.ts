  ...
  console: {
    dashboard: {
      ...
      projects: {
        ...
        emptyDescription: "Create a project to begin organizing environments and resources.",
        emptyTitle: "No projects yet",
        loading: "Loading projects",
        loadError: "Projects could not be loaded",
        loadErrorDescription: "Check the control plane connection and try again.",
        noActivity: "No activity yet",
        sortNameAsc: "Name A–Z",
        sortNameDesc: "Name Z–A",
        sortRecent: "Recent activity",
        summaryDescription: "Counts and attention state come from one bounded owner-scoped query.",
        summaryTitle: "{{count}} projects on this page",
      },
      project: {
    ...
    auditLog: {
      ...
      columnResult: "Result",
      empty: "No audit events in the selected time range.",
      paginationLabel: "Showing {{count}} of up to {{limit}} events",
      previousPage: "Previous page",
      nextPage: "Next page",
      unavailableBadge: "Unavailable",
      unavailableTitle: "Audit events unavailable",
      unavailableDescription: "Audit events could not be loaded.",
      runtimeNotReady: "Audit log runtime is not ready.",
      errorFallback: "Audit events could not be loaded.",
      ...
      actions: {
        ...
        domainBindingsCreate: "Create domain binding",
        serversCreate: "Create server",
        staticArtifactsPublish: "Publish static artifact",
        serverCapacityPruned: "Prune server capacity",
        storageVolumeRuntimeCleaned: "Clean storage volume runtime",
        terminalSessionOpened: "Open terminal session",
        terminalSessionClosed: "Close terminal session",
        resourceVariableSet: "Set resource variable",
        resourceCreated: "Create resource",
        serverRenamed: "Rename server",
      },
      actionFilters: {
        create: "Create",
        archive: "Archive",
      ...
      resourceTypes: {
        ...
        domainBinding: "Domain binding",
        server: "Server",
        staticArtifact: "Static artifact",
    ...
    accountSettings: {
      ...
      managedClusterAcceptPlan: "Accept exact plan",
      managedClusterAccepting: "Accepting plan",
      managedClusterApplyAction: "Apply accepted plan",
      managedClusterApplying: "Applying plan",
      managedClusterActivePlacements: "Active placements",
      managedClusterAttempt: "Attempt",
      managedClusterAvailableCapacity: "Available capacity",
      managedClusterCapability: "Managed cluster action",
      managedClusterClass: "Cluster class",
      managedClusterCleanup: "Exact cleanup",
      managedClusterCleanupSupported: "Supported",
      managedClusterCleanupUnavailable: "Unavailable",
      managedClusterCost: "Estimated monthly cost",
      ...
      managedClusterLifecycle: "Capacity lifecycle",
      managedClusterOrigin: "Capacity origin",
      managedClusterPlacementEpoch: "Current placement epoch",
      managedClusterPlanAccepted: "This exact plan is accepted and ready to apply.",
      managedClusterPlanAction: "Generate plan",
      managedClusterPlanTitle: "Review plan",
      managedClusterPlanning: "Generating plan",
      managedClusterProviderDisposition: "Provider resource on delete",
      ...
      managedClusterResidualResources: "Residual owned resources",
      managedClusterSelectedTarget: "Selected target",
      managedClusterStatus: "Status",
      managedClusterSupport: "Support level",
      managedClusterUnavailable:
        "Managed cluster capacity is not available for the active organization.",
      managedClusterWorkloadRef: "Workload reference",
      managedTrafficActiveEndpoint: "Active endpoint",
      managedTrafficCurrentEndpoint: "Current endpoint reference",
      managedTrafficCurrentFence: "Current fencing token",
      managedTrafficHealthObservedAt: "Health observed at (ISO)",
      managedTrafficHealthProof: "Health proof reference",
      managedStateMode: "Workload state mode",
      managedStateRpoObjective: "Maximum recovery point age (seconds)",
      managedStateRtoObjective: "Maximum recovery time (seconds)",
      managedStateEvidenceKind: "State evidence kind",
      managedStateDurabilityEvidence: "Durability evidence reference",
      managedStateBackupEvidence: "Backup evidence reference",
      managedStateRestoreEvidence: "Restore rehearsal reference",
      managedStateSourceTarget: "State source target",
      managedStateRecoveryTarget: "State recovery target",
      managedStateEvidenceObservedAt: "State evidence observed at",
      managedStateEvidenceValidUntil: "State evidence valid until",
      managedStateObservedRpo: "Observed recovery point age (seconds)",
      managedStateObservedRto: "Observed recovery time (seconds)",
      managedStateReasons: "State eligibility reasons",
      managedTrafficHealthValidUntil: "Health valid until (ISO)",
      managedTrafficNextFence: "Next fencing token",
      managedTrafficOutcome: "Traffic outcome",
      managedTrafficPlannedAt: "Planned at (ISO)",
      managedTrafficReplacementEndpoint: "Replacement endpoint reference",
      managedTrafficReplacementTarget: "Replacement target ID",
      managedTrafficRollbackAttempts: "Rollback attempts",
      managedTrafficRouteRef: "Traffic route reference",
    ...
    deployments: {
      ...
      proofHealth: "Internal health",
      proofMismatches: "Mismatches and recommended operations",
      proofRecovery: "Recovery",
      proofRecoveryRetained: "Previous runtime retained",
      proofRecoveryUnavailable: "Previous runtime not retained or unavailable",
      proofRuntime: "Runtime identity / generation",
      proofSource: "Source",
      proofTitle: "Deployment proof",
      proofUnavailable: "Unavailable evidence",
      proofVerdictFailed: "Failed",
      proofVerdictPartiallyVerified: "Partially verified",
      proofVerdictStale: "Stale",
      proofVerdictUnverified: "Unverified",
      proofVerdictVerified: "Verified",
      ...
      sourceEventTriggerTitle: "Source event trigger",
      sourceEventTriggerDescription:
        "This deployment was created after the final source change matched the Resource policy.",
      sourceEventFinalDiff: "Final diff",
      sourceEventMatchedPaths: "Matched paths",
      latestTitle: "Latest",
      noFailureSummary:
    ...
    instance: {
      ...
      pageTitle: "Instance",
      portabilityArtifactLabel: "Encrypted artifact",
      portabilityBody:
        "Export or restore the complete control-plane state with an encrypted, revision-checked artifact. Replace mode creates a rollback artifact first.",
      portabilityDelete: "Delete artifact",
      portabilityExport: "Export encrypted artifact",
      portabilityExportPlan: "Export plan",
      portabilityImport: "Run import",
      portabilityImportPlan: "Validate import",
      portabilityModeLabel: "Import mode",
      portabilityPassphraseLabel: "Artifact passphrase",
      portabilityTitle: "Portability",
      tunnelsTitle: "Temporary tunnels",
      tunnelsBody:
        "Expose a loopback or private-network origin temporarily through Cloudflare Quick Tunnel or ngrok, with explicit expiry and revocation.",
      tunnelProvider: "Provider",
      tunnelOrigin: "Private origin URL",
      tunnelDurationMinutes: "Duration (minutes)",
      tunnelSafetyNotice:
        "Only HTTP(S) loopback and private-network origins are accepted. Maximum duration is 24 hours.",
      tunnelStart: "Start tunnel",
      tunnelStartUnavailable:
        "Starting a tunnel is disabled by this instance policy. Hosted Cloud never exposes its control-plane network through local tunnel agents.",
      tunnelSessions: "Tunnel sessions",
      tunnelExpiresAt: "Expires",
      tunnelRevoke: "Revoke",
      tunnelEmpty: "No tunnel sessions yet.",
      ...
      workerSafetyPolicyGatedBackup: "Policy-gated storage backup only",
      ...
      workerSafetyTunnelSessionCleanup: "Expired and orphan tunnel cleanup only",
    ...
    agentWorkspaces: {
      ...
      createTitle: "New agent workspace",
      creating: "Creating workspace…",
      delete: "Delete workspace",
      deleteDialogDescription:
        "This permanently deletes the workspace, its agent runtimes, terminal sessions and preview routes.",
      deleteDialogTitle: "Delete this workspace?",
      ...
      nativeSession: "Native session recovery",
      noRuntime: "No compatible agent runtime is attached to this workspace.",
      open: "Open workspace",
      pageDescription:
        "Run, reconnect and review Pi or OpenCode work in isolated remote environments.",
      ...
      runtime: "Runtime",
      status: "Status",
      taskEmpty: "No task runs yet.",
      taskMode: "Task mode",
      taskPrompt: "Describe the change to make",
      taskRun: "Run task",
      taskRunning: "Submitting task…",
      tasksDescription:
        "Run a durable task, inspect checks and changes, then approve source-control delivery.",
      tasksTitle: "Task runs",
      terminalDescription:
        "The managed terminal can reconnect without exposing host SSH credentials.",
      terminalTitle: "Workspace terminal",
      template: "Workspace template",
      viewChanges: "Changes",
    },
    workspaceCollaborations: {
      accept: "Accept",
      acquireWriter: "Take writer lease",
      addLane: "Add lane",
      addParticipant: "Add participant",
      artifactId: "Review artifact ID",
      branch: "Branch",
      create: "New collaboration",
      createTitle: "Coordinate workspaces",
      digest: "SHA-256 digest",
      emptyBody:
        "Group isolated workspaces into builder, reviewer and test lanes without sharing a working directory.",
      emptyTitle: "No workspace collaborations yet",
      expiresAt: "Lease expires",
      handoffs: "Review handoffs",
      initialWorkspace: "Initial workspace",
      interactiveTerminal: "Interactive terminal",
      laneLabel: "Lane label",
      lanes: "Workspace lanes",
      name: "Collaboration name",
      nativeAttach: "Issue native attach",
      nativeAttachCommand: "Native attach command",
      noHandoffs: "No review handoffs yet.",
      noPreview: "No active preview",
      observerTerminal: "Observer terminal",
      offerHandoff: "Offer artifact",
      open: "Open collaboration",
      pageDescription:
        "Coordinate people and Agent runtimes across isolated workspaces with fenced writers, live observation and review handoffs.",
      pageTitle: "Workspace collaboration",
      ...
      status: "Status",
      subjectId: "User or Agent Runtime ID",
      targetLane: "Target lane",
      transferTo: "Transfer to participant",
      transferWriter: "Transfer writer",
    ...
    resources: {
      ...
      storageBackupSecretRef: "Credential secret ref",
      storageBackupSecretRefPlaceholder: "Optional for managed Cloud storage",
      ...
      storageBackupAutomationTitle: "Backup automation",
      storageBackupAutomationDescription:
        "Run this verified backup on a schedule or before deployments, then retain the latest safe restore points.",
      storageBackupScheduledEnabled: "Run on a schedule",
      storageBackupPreDeployEnabled: "Run before deployments",
      storageBackupScheduleIntervalHours: "Interval (hours)",
      storageBackupFailureMode: "Pre-deploy failure behavior",
      storageBackupNotificationRef: "Failure notification connector",
      storageBackupRetryOnFailure: "Retry failed scheduled runs",
      storageBackupNextRunAt: "Next run",
      storageBackupLastOutcome: "Last outcome",
      storageBackupNotificationStatus: "Notification:",
      storageBackupPolicyConfigureAction: "Save automation policy",
      storageBackupPolicyConfigured: "Backup automation policy saved",
      storageBackupPolicyConfigureFailed: "Backup automation policy was not saved",
      ...
      autoDeployIncludePaths: "Include paths",
      autoDeployIncludePathsPlaceholder: "apps/api/**\npackages/shared/**",
      autoDeployExcludePaths: "Exclude paths",
      ...
      sourceEventIgnoredPathDiffUnavailable: "Final path diff unavailable",
      sourceEventIgnoredPathNotMatched: "Final changed paths did not match",
      sourceEventIgnoredRefDeleted: "Deleted ref",
