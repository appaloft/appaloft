...
export const enUS = {
  ...
  console: {
    ...
    dependencyResources: {
      ...
      managedOnlyNotice: "Appaloft-managed Docker-backed service",
      modeCreate: "Create",
      modeCreateDescription: "Create a managed Docker-backed dependency resource.",
      modeReuse: "Reuse",
    ...
    projects: {
      ...
      emptyBody:
        "A project owns environments, resources, deployment history, and access records. Create the boundary first, then add resources or start deployment from inside it.",
      ...
      createProjectDescription:
        "Name the workspace boundary first. After it exists, the project page becomes the place to add resources, environments, and deployments.",
      ...
      environmentCreateDescription:
        "Create a project-scoped configuration boundary before binding resources or deployments to it.",
