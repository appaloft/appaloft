export const tokens = {
  ...
  deploymentHealthChecker: Symbol.for("yundu.deployment_health_checker"),
  ...
  cancelDeploymentUseCase: Symbol.for("yundu.cancel_deployment_use_case"),
  checkDeploymentHealthUseCase: Symbol.for("yundu.check_deployment_health_use_case"),
  ...
  redeployResourceUseCase: Symbol.for("yundu.redeploy_resource_use_case"),
  reattachDeploymentUseCase: Symbol.for("yundu.reattach_deployment_use_case"),
