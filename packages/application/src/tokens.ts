export const tokens = {
  ...
  domainRouteBindingReader: Symbol.for("yundu.domain_route_binding_reader"),
  ...
  certificateReadModel: Symbol.for("yundu.certificate_read_model"),
  ...
  issueOrRenewCertificateUseCase: Symbol.for("yundu.issue_or_renew_certificate_use_case"),
  certificateRetryScheduler: Symbol.for("yundu.certificate_retry_scheduler"),
  listCertificatesQueryService: Symbol.for("yundu.list_certificates_query_service"),
