export const tokens = {
  ...
  sandboxAgentProcessCredentialGrants: Symbol.for(
    "appaloft.sandbox_agent_process_credential_grants",
  ),
  ...
  occupancyAgentRepository: Symbol.for("appaloft.occupancy_agent_repository"),
  ...
  workspaceActivationContextInitializer: Symbol.for(
    "appaloft.workspace_activation_context_initializer",
  ),
  ...
  sandboxAgentPromotionTarget: Symbol.for("appaloft.sandbox_agent_promotion_target"),
  sandboxAgentWorkQueue: Symbol.for("appaloft.sandbox_agent_work_queue"),
  ...
  projectSummariesReadModel: Symbol.for("appaloft.project_summaries_read_model"),
  projectEnvironmentOverviewReadModel: Symbol.for(
    "appaloft.project_environment_overview_read_model",
  ),
  ...
  resourceOverviewReadModel: Symbol.for("appaloft.resource_overview_read_model"),
  ...
  listProjectSummariesQueryService: Symbol.for("appaloft.list_project_summaries_query_service"),
  projectEnvironmentOverviewQueryService: Symbol.for(
    "appaloft.project_environment_overview_query_service",
  ),
  resourceOverviewQueryService: Symbol.for("appaloft.resource_overview_query_service"),
  ...
  configureResourceScaleUseCase: Symbol.for("appaloft.configure_resource_scale_use_case"),
  configureResourceRolloutUseCase: Symbol.for("appaloft.configure_resource_rollout_use_case"),
  ...
  deploymentProofRuntimeEvidenceReader: Symbol.for(
    "appaloft.deployment_proof_runtime_evidence_reader",
  ),
  ...
  connectionsQueryService: Symbol.for("appaloft.connections_query_service"),
  connectionQueryService: Symbol.for("appaloft.connection_query_service"),
  ...
  connectorCapabilityApplyUseCase: Symbol.for("appaloft.connector_capability_apply_use_case"),
  ...
  connectorAuthorizationAttemptStore: Symbol.for("appaloft.connector_authorization_attempt_store"),
