...
export class CreateDomainBindingCommand extends Command<{ id: string }> {
  constructor(
    ...
    public readonly serverId: CreateDomainBindingCommandInput["serverId"],
    public readonly destinationId: CreateDomainBindingCommandInput["destinationId"],
    public readonly domainName: string,
    public readonly pathPrefix: string,
    public readonly pathHandling: NonNullable<
      CreateDomainBindingCommandInput["pathHandling"]
    > = "preserve",
    ...
    public readonly targetServiceName?: CreateDomainBindingCommandInput["targetServiceName"],
