...
import { type ImportRedisDependencyResourceCommandInput } from "./import-redis-dependency-resource.command";
import { maskRedisConnectionUrl } from "./redis-connection-masking";

@injectable()
export class ImportRedisDependencyResourceUseCase {
  constructor(
  ...
  async execute(
    ...
    return safeTry(async function* () {
      ...
      const endpoint = yield* maskRedisConnectionUrl(input.connectionUrl);
      ...
      yield* project.ensureCanAcceptMutation("dependency-resources.import-redis");
