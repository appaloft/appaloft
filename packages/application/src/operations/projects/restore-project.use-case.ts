...
import { type RestoreProjectCommandInput } from "./restore-project.command";
...
export class RestoreProjectUseCase {
  ...
  async execute(
    ...
    input: RestoreProjectCommandInput,
    ...
    return safeTry(async function* () {
      ...
      const restoreResult = yield* project.restore({ restoredAt });
