...
export const operationCatalog = [
  ...
  },
  {
    ...
    transports: {
      cli: "appaloft deploy [path-or-source] [--yes] [--project <projectId>] [--config appaloft.yml] [--application <config-key>] [--env KEY=VALUE] [--secret KEY=ci-env:NAME] [--preview pull-request]; appaloft deployments create --project <projectId> --environment <environmentId> --resource <resourceId> --server <serverId> [--destination <destinationId>]",
  ...
  {
    key: "sandboxes.agents.harnesses.list",
    kind: "query",
    domain: "sandboxes",
    messageName: "ListSandboxAgentHarnessesQuery",
    handlerName: "SandboxAgentQueryHandler",
    serviceName: "SandboxAgentDeliveryService",
    inputSchema: listSandboxAgentHarnessesInputSchema,
    serviceToken: tokens.sandboxAgentDeliveryService,
    transportAccess: { productSession: { minRole: "member" } },
    transports: {
      cli: "appaloft workspace harness list",
      orpc: { method: "GET", path: "/api/sandbox-agent-harnesses" },
    },
  },
  {
    key: "sandboxes.agents.runtimes.create",
    kind: "command",
    domain: "sandboxes",
    messageName: "CreateSandboxAgentRuntimeCommand",
    handlerName: "SandboxAgentCommandHandler",
    serviceName: "SandboxAgentDeliveryService",
    inputSchema: createSandboxAgentRuntimeInputSchema,
    serviceToken: tokens.sandboxAgentDeliveryService,
    transportAccess: { productSession: { minRole: "member" } },
    transports: {
  ...
  {
    key: "sandboxes.agents.runtimes.attach",
    kind: "command",
    domain: "sandboxes",
    messageName: "IssueSandboxAgentAttachAccessCommand",
    handlerName: "SandboxAgentCommandHandler",
    serviceName: "SandboxAgentDeliveryService",
    inputSchema: issueSandboxAgentAttachAccessInputSchema,
    serviceToken: tokens.sandboxAgentDeliveryService,
    transportAccess: { productSession: { minRole: "member" } },
    transports: {
      cli: "appaloft workspace attach <workspaceId>",
      orpc: {
        method: "POST",
        path: "/api/sandboxes/{sandboxId}/agent-runtimes/{runtimeId}/attach",
      },
    },
  },
  ...(
    [
      [
        ...
        createAgentTaskRunInputSchema,
        "POST",
        "/api/sandboxes/{workspaceId}/agent-task-runs",
      ...
      [
        ...
        "GET",
        "/api/sandboxes/{workspaceId}/agent-task-runs",
        "appaloft workspace task list <workspaceId>",
      ],
      [
        ...
        showAgentTaskRunInputSchema,
        "GET",
        "/api/sandboxes/{workspaceId}/agent-task-runs/{taskRunId}",
      ...
      [
        ...
        resumeAgentTaskRunInputSchema,
        "POST",
        "/api/sandboxes/{workspaceId}/agent-task-runs/{taskRunId}/resume",
      ...
      [
        ...
        cancelAgentTaskRunInputSchema,
        "POST",
        "/api/sandboxes/{workspaceId}/agent-task-runs/{taskRunId}/cancel",
        "appaloft workspace task cancel <workspaceId> <taskRunId>",
      ],
      [
        ...
        approveAgentTaskRunInputSchema,
        "POST",
        "/api/sandboxes/{workspaceId}/agent-task-runs/{taskRunId}/approve",
      ...
      [
        ...
        deliverAgentTaskRunInputSchema,
        "POST",
        "/api/sandboxes/{workspaceId}/agent-task-runs/{taskRunId}/deliver",
        "appaloft workspace task deliver <workspaceId> <taskRunId>",
      ],
    ] as const
  ).map(([key, messageName, handlerName, inputSchema, method, path, cli]) => ({
    key,
    kind: handlerName === "AgentTaskRunCommandHandler" ? ("command" as const) : ("query" as const),
  ...
  ...(
    [
      [
        ...
        "appaloft sandbox agent runtime list <sandboxId>",
      ],
      [
        ...
        "appaloft sandbox agent runtime show <sandboxId> <runtimeId>",
      ],
      [
        ...
        "appaloft sandbox agent runtime terminate <sandboxId> <runtimeId>",
      ],
      [
        ...
        "appaloft sandbox agent run create <sandboxId> <runtimeId>",
      ],
      [
        ...
        "appaloft sandbox agent run list <runtimeId>",
      ],
      [
        ...
        "appaloft sandbox agent run show <runtimeId> <runId>",
      ],
      [
        ...
        "appaloft sandbox agent run cancel <runtimeId> <runId>",
      ],
      [
        ...
        "appaloft sandbox agent run events <runId>",
      ],
      [
        ...
        "appaloft sandbox agent approval list <runId>",
      ],
      [
        ...
        "appaloft sandbox agent approval show <approvalId>",
      ],
      [
        ...
        "appaloft sandbox agent approval resolve <approvalId>",
      ],
      [
        ...
        "appaloft sandbox artifact create <sandboxId>",
      ],
      [
        ...
        "GET",
        "/api/sandboxes/{sandboxId}/source-artifacts",
        "appaloft sandbox artifact list <sandboxId>",
      ],
      [
        ...
        "appaloft sandbox artifact show <artifactId>",
      ],
      [
        ...
        "DELETE",
        "/api/sandbox-source-artifacts/{artifactId}",
        "appaloft sandbox artifact delete <artifactId>",
      ],
      [
        ...
        "appaloft sandbox preview create <artifactId>",
      ],
      [
        ...
        "appaloft sandbox preview show <previewId>",
      ],
      [
        ...
        "DELETE",
        "/api/sandbox-candidate-previews/{previewId}",
        "appaloft sandbox preview delete <previewId>",
      ],
      [
        ...
        "appaloft sandbox promote plan <sandboxId>",
      ],
      [
        ...
        "appaloft sandbox promote list <sandboxId>",
      ],
      [
        ...
        "appaloft sandbox promote show <promotionId>",
      ],
      [
        ...
        "appaloft sandbox promote accept <promotionId>",
      ],
      [
        ...
        "appaloft sandbox promote retry <promotionId>",
      ],
    ] as const
  ).map(([key, messageName, handlerName, inputSchema, method, path, cli]) => ({
    key,
    kind: handlerName === "SandboxAgentCommandHandler" ? ("command" as const) : ("query" as const),
    domain: "sandboxes" as const,
    messageName,
    handlerName,
    serviceName: "SandboxAgentDeliveryService",
  ...
  {
    key: "sandboxes.events.stream",
    kind: "query",
    domain: "sandboxes",
    messageName: "StreamSandboxEventsQuery",
    handlerName: "SandboxQueryHandler",
    serviceName: "ExecutionSandboxService",
    inputSchema: streamSandboxEventsQueryInputSchema,
    serviceToken: tokens.executionSandboxService,
    transportAccess: { productSession: { minRole: "member" } },
    transports: {
      cli: "appaloft sandbox events <sandboxId> --follow",
      orpcStream: { method: "GET", path: "/api/sandboxes/{sandboxId}/events/stream" },
    },
  },
  {
    key: "sandbox-credentials.grant",
    kind: "command",
    domain: "sandboxes",
    messageName: "GrantSandboxCredentialCommand",
    handlerName: "SandboxCommandHandler",
    serviceName: "ExecutionSandboxService",
    inputSchema: grantSandboxCredentialCommandInputSchema,
    serviceToken: tokens.executionSandboxService,
    transportAccess: { productSession: { minRole: "member" } },
    transports: {
      orpc: { method: "POST", path: "/api/sandboxes/{sandboxId}/credentials" },
    },
  },
  {
    key: "sandbox-credentials.list",
    kind: "query",
    domain: "sandboxes",
    messageName: "ListSandboxCredentialGrantsQuery",
    handlerName: "SandboxQueryHandler",
    serviceName: "ExecutionSandboxService",
    inputSchema: listSandboxCredentialGrantsQueryInputSchema,
    serviceToken: tokens.executionSandboxService,
    transportAccess: { productSession: { minRole: "member" } },
    transports: {
      orpc: { method: "GET", path: "/api/sandboxes/{sandboxId}/credentials" },
    },
  },
  {
    key: "sandbox-credentials.revoke",
    kind: "command",
    domain: "sandboxes",
    messageName: "RevokeSandboxCredentialCommand",
    handlerName: "SandboxCommandHandler",
    serviceName: "ExecutionSandboxService",
    inputSchema: revokeSandboxCredentialCommandInputSchema,
    serviceToken: tokens.executionSandboxService,
    transportAccess: { productSession: { minRole: "member" } },
    transports: {
      orpc: {
        method: "DELETE",
        path: "/api/sandboxes/{sandboxId}/credentials/{grantId}",
      },
    },
  },
  {
    key: "sandbox-credentials.request",
    kind: "command",
    domain: "sandboxes",
    messageName: "BrokerSandboxCredentialRequestCommand",
    handlerName: "SandboxCommandHandler",
    serviceName: "ExecutionSandboxService",
    inputSchema: brokerSandboxCredentialRequestCommandInputSchema,
    serviceToken: tokens.executionSandboxService,
    transportAccess: { productSession: { minRole: "member" } },
    transports: {
      orpc: {
        method: "POST",
        path: "/api/sandboxes/{sandboxId}/credentials/{grantId}/request",
      },
    },
  },
  ...(
  ...
  ...(
    [
      ...
      [
        ...
        "DELETE",
        "/api/sandbox-snapshots/{snapshotId}",
        "appaloft sandbox snapshot delete <snapshotId>",
      ],
    ] as const
  ).map(([key, messageName, kind, inputSchema, method, path, cli]) => ({
    key,
  ...
  ...(
    [
      [
        "sandbox-templates.create",
        "CreateSandboxTemplateCommand",
        "command",
        createSandboxTemplateCommandInputSchema,
        "POST",
        "/api/sandbox-templates",
        "appaloft sandbox template create",
      ],
      [
        ...
        "GET",
        "/api/sandbox-templates",
        "appaloft sandbox template list",
      ],
      [
        "sandbox-templates.show",
        "ShowSandboxTemplateQuery",
        "query",
        showSandboxTemplateQueryInputSchema,
        "GET",
        "/api/sandbox-templates/{templateId}",
        "appaloft sandbox template show <templateId>",
      ],
      [
        "sandbox-templates.delete",
        "DeleteSandboxTemplateCommand",
        "command",
        deleteSandboxTemplateCommandInputSchema,
        "DELETE",
        "/api/sandbox-templates/{templateId}",
        "appaloft sandbox template delete <templateId>",
      ],
    ] as const
  ).map(([key, messageName, kind, inputSchema, method, path, cli]) => ({
    key,
